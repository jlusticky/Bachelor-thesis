...
\projectinfo{
  ...
  abstract.en={Purpose of the thesis is to describe operating system for embedded systems Contiki, NTP time synchronisation protocol and to design and implement NTP client for
  ...
  for providing equipped workplace in laboratory and helping me with hardware setup,
