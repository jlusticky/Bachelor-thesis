...
\projectinfo{
  ...
  %===========================================================================
  %Klicova slova
  keywords.cs={operační systém, Contiki, synchronizace času, NTP, SNTP, síť, vestavěné systémy, komunikace, protokol}, %klicova slova v ceskem jazyce
  keywords.en={operating system, Contiki, time synchronization, NTP, SNTP, network, embedded systems, communication, protocol}, %klicova slova v anglickem jazyce
  %Abstract
  ...
  abstract.en={Purpose of the thesis is to describe operating system for embedded systems Contiki, time synchronization protocol NTP and to design and implement NTP client for
  ...
  acknowledgment={I would like to thank my supervisor Ing. Tomáš Kašpárek for helping me with practical advices and leadership.} % nepovinne
}
