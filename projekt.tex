...
\projectinfo{
  ...
  %===========================================================================
  %Klicova slova
  keywords.cs={operační systém, Contiki, synchronizace času, NTP, síť, vestavěné systémy, komunikace, protokol}, %klicova slova v ceskem jazyce
  keywords.en={operating system, Contiki, time synchronization, NTP, network, embedded systems, communication, protocol}, %klicova slova v anglickem jazyce
  %Abstract
