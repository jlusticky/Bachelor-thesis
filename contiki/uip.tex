...
Protosockets are based on Protothreads, which puts the same limitation on them - such as %LYDIA what imposes
...
but its complete description is outside the scope of this thesis. %!LYDIA
