...
All earlier IP implementations for general purpose computers %!LYDIA
...
based on what the typical sensor network protocols use - %!LYDIA
...
The operating system Contiki, uIP and Protothreads are used by hundreds of companies on embedded devices in %!LYDIA
