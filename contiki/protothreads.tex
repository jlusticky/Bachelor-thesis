...
There is also no way to store automatic local variables~\cite{contiki-docs}. %LYDIA of
And since Protothreads are implemented using a C {\it switch} statement, and these can %!LYDIA
