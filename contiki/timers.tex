...
The timer modules are implemented with the functionality of the clock module as base~\cite{contiki-wiki-timers}.
...
%! TODO FROM HERE - usage in appendix A + clock_second
