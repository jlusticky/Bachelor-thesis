...
The operating system maintains the current time and advances it at every interrupt.
...
The structure of the clock hardware is shown in figure~\ref{fig:system-pc-clock}.
\begin{figure}
  \centering
