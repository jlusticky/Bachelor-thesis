...
\chapter{Analysis}
For keeping, measuring and resolving the time, a computer needs a hardware clock.
...
Figure~\ref{fig:analysis-overview} shows the overview of the necessary NTP client components.
The interface....TODO
