...
\begin{itemize}
	...
	\item Programmer (flasher) for AVR - avrdude - http://www.nongnu.org/avrdude/
	\item Toolchaing for AVR - avr-libc, binutils-avr, gcc-avr
	\item Optional debugger (GDB) and interface between AVR JTAG and GDB - gdb-avr, avarice - http://avarice.sourceforge.net/
