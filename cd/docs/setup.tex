...
In this case, the Contiki project must be compiled with the following line in the Makefile:\\
{\it{CFLAGS+=-DRAVEN\_LCD\_INTERFACE=1}} \\
See an example in platform/avr-raven/apps/raven-lcd-interface directory
and article {\it{Serial interface between Raven processors}} in Contiki documentation.
