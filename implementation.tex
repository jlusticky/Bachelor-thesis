...
Another deal is possible packet loss when communication uses UDP on transport layer.
The reason while this can often happen is explained in section \sec{sec:contiki-uip}.
