...
for negative values.
As the 32-bit unsigned long type can express values from 0 to $2^{32}$ (4~294~967~296),
...
one second has 1~000~000 microseconds, which is more that maximum expressible value of signed 16-bit
type $2^{16}$ (65~536).
