...
Figure~\ref{fig:app-osc-speed-up} in appendix~\ref{app:interrupt-frequency} shows the~output from oscilloscope
...
Due to the frequency jitter, that can be also observed,
