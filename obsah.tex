...
Network Time Protocol version~4 and the design and implementation of an NTP client for the Contiki operating system.
...
The measured results show that the Contiki NTP client keeps a reasonably accurate time.
